...
class UpdaterMod(loader.Module):
    ...
    strings = {"name": "Updater",
               ...
               "downloading": "<b>Установка обновлений🖤...</b>",
               "downloaded": ("<b>Скачивание завершено.\nВведите</b> "
                              "<code>.restart</code> <b>для перезагрузки.🖤</b>"),
               "already_updated": "<b>Полностью обновлён!🖤</b>",
               "installing": "<b>Установка обновлений🖤...</b>",
               "success": "<b>Перезагружено!🖤</b>",
               "success_meme": "<b>Перезагружка удачно провалена‽🖤</b>",
...
on = get("https://raw.githubusercontent.com/LuciferStone/zip/master/Start.mp3").content
off = get("https://raw.githubusercontent.com/LuciferStone/zip/master/stop.mp3").content
SHUTDOWN = io.BytesIO(off)
SHUTDOWN.name = "stop.mp3"
STARTUP = io.BytesIO(on)
STARTUP.name = "Start.mp3"
